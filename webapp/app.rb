...
def event2hash(e)
  ...
  hash[:channel_name] = e.extended_properties.shared["channel_name"] if e.extended_properties && e.extended_properties.shared && e.extended_properties.shared["channel_name"]
